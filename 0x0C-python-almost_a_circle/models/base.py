...
class Base:
    """Base model
        This represents the base of all the other classes in 0x0C
    ...
    def save_to_file(cls, list_objs):
        """Write the JSON serialization of a list of objects
            to a file
        Args:
            list_objs(int): a list of inherited base instances.
        """
    ...
    def load_from_file(cls):
        ...
        Returns: 
            if the file doesnt exist - empty list
            otherwise - a list of instantiated
        """
